  ...
  constructor(props) {
    ...
    this.state = {
      ...
      products: [
        {
          name: 'Backpack',
          images: [require('./assets/bag.png')],
          price: '$299',
        },
        {
          name: 'Umbrella',
          images: [require('./assets/umbrella.png')],
          price: '$249',
        },
        {
          name: 'Jacket',
          images: [require('./assets/leather_jacket.png')],
          price: '$499',
        },
        {
          name: 'Shoes',
          images: [require('./assets/shoes.png')],
          price: '$199',
        },
        {
          name: `Women's Jacket`,
          images: [require('./assets/ladies_jacket.png')],
          price: '$499',
        },
        {
          name: 'Cap',
          images: [require('./assets/cap.png')],
          price: '$99',
        },
      ],
    };
    ...
    return (
      <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <View>
          <ScrollView
            horizontal
            contentContainerStyle={{paddingHorizontal: theme, paddingVertical: EStyleSheet.value('10rem')}}
